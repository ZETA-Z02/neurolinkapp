...
////            )
////
////            for ((index, group) in radioGroups.withIndex()) {
////                val seleccion = group.checkedRadioButtonId
////                val opcionSeleccionada = group.indexOfChild(group.findViewById(seleccion))
////                respuestas.add(opcionSeleccionada + 1) // valor 1 a 5
////            }
//            // No tocar /*
//            idusuario = intent.getIntExtra("idusuario", -1)
//            val intent = Intent(this, MainActivity::class.java)
